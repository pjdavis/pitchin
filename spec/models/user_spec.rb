...
describe User do
  ...
  it "can have many tasks" do
    ...
    user.tasks << tasks(:default)
    user.tasks.should_not be_empty
    user.tasks.first.should == tasks(:default)
  end
  ...
  it "can have many roles" do
    ...
    user.roles.first.should == roles(:default)
  end
  
  it "can have many types" do
    user = users(:default)
    user.types.should be_empty
    user.types << types(:default)
    user.types.should_not be_empty
    user.types.first.should == types(:default)
  end
  
  it "can only see tasks of the same type" do
    users(:with_types).avaliable_tasks.should include( tasks(:type_one) )
    users(:with_types).avaliable_tasks.should include( tasks(:type_two) )
